...
* Submit a ticket for your issue, assuming one does not already exist.
  * Raise it on our [Issue Tracker](https://github.com/strangerstudios/pmpro-constant-contact/issues/new/choose)
...
* For bug fixes, checkout the master branch of the PMPro repository.
...
* Make sure to pull in any "upstream" changes first.
	* Use `git remote add upstream https://github.com/strangerstudios/pmpro-constant-contact.git` to set the upstream repo
	* Use `git checkout master` to get on the main branch.
	* Use `git pull upstream master` to get the latest updates.
...
* For bug fixes, submit a pull request to the master branch of the PMPro repository.
